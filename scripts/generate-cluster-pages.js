...
const PAGES_DATA = [
    ...
    },
    {
        ...
        type: 'package',
        title: 'Kashmir Adventure Tour Packages | Trekking, Rafting & Skiing',
        description: 'Book Kashmir adventure tours with Northwind Kashmir. Alpine lake trekking, white-water rafting, paragliding, and backcountry skiing in Gulmarg.',
        h1: 'Kashmir Adventure Tour Packages',
        subtitle: 'Explore the valleys with trekking, skiing, and water sports packages.',
        content: `
            <div class="space-y-8">
                <div>
                    <h2 class="font-display text-3xl font-bold text-[#0B1F3A] mb-4">1. Adventure and Mountain Sports in Kashmir</h2>
                    <p class="text-sm text-gray-700 leading-relaxed sm:text-base">
                        Kashmir offers a range of activities for adventure seekers. From skiing on deep powder snow in Gulmarg to trekking across alpine lakes, the terrain provides opportunities for outdoor enthusiasts.
                    </p>
                    <p class="text-sm text-gray-700 leading-relaxed sm:text-base mt-3">
                        Our adventure packages include certified local guides, safety gear, and comfortable base camps. We organize popular treks like the Kashmir Great Lakes and winter ski programs.
                    </p>
                </div>
            </div>
        `
      ...
      "@graph": [
        ...
        },
        {
          ...
          "mainEntity": [
            {
              "@type": "Question",
              "name": "What is the best way to visit ${page.h1}?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Booking a custom tour with Northwind Kashmir offers private transport, hotel arrangements, and direct support."
              }
            },
            {
              "@type": "Question",
              "name": "Is travel to this destination safe?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Yes, Kashmir is a safe travel destination for families, couples, and international tourists."
              }
            }
          ]
        }

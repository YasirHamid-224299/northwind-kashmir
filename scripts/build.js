...
fs.readdirSync(root).forEach((file) => {
    ...
    if (fs.statSync(fullPath).isDirectory() && (fs.existsSync(path.join(fullPath, 'index.html')) || ['packages', 'destinations', 'hotels', 'gondola', 'trip-stories', 'plan-your-trip', 'author'].includes(file.toLowerCase()))) {
